    ...
    : EndpointTestBase(factory, outputHelper)
{
    ...
    public async Task Get_WhenUnauthorized_ShouldBeUnauthorized()
    {
        ...
        var response = await client.GetAsync(Testing.Endpoints.DecisionNotifications.Get("mrn", null, null));
    ...
    public async Task Get_WhenNoParameters_ShouldBeBadRequest()
    {
        ...
        var response = await client.GetAsync(Testing.Endpoints.DecisionNotifications.Get(null, null, null));
    ...
    public async Task Get_WhenFromGreaterThanTo_ShouldBeBadRequest()
    {
        ...
        var response = await client.GetAsync(
            Testing.Endpoints.DecisionNotifications.Get(null, DateTime.UtcNow.AddDays(1), DateTime.UtcNow)
        );
