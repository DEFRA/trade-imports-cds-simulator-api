...
public class EndpointTestBase : IClassFixture<SimulatorWebApplicationFactory>
{
    private readonly SimulatorWebApplicationFactory _factory;

    protected EndpointTestBase(SimulatorWebApplicationFactory factory, ITestOutputHelper outputHelper)
    {
        _factory = factory;
